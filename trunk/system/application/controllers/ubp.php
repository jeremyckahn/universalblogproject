...
class UBP extends Controller {
	...
	****************************************/
	...
	/*function convert(){
		...
		$this->UBP_DAL->convertUserTable($data, $db);
		
		$data = $this->UBP_DAL->getOldData("blogs");
		$this->UBP_DAL->convertBlogTable($data, $db, $this->UBP_DAL_HELPER);
		
		$data = $this->UBP_DAL->getOldData("blacklists");
		$this->UBP_DAL->convertBlacklistTable($data, $db, $this->UBP_DAL_HELPER);
